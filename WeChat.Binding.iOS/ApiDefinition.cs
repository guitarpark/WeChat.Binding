...
namespace WeChat.Binding.iOS
{
    ...
    {
        // @optional -(void)onReq:(id)req;
        [Export("onReq:")]
        void OnReq(BaseReq req);

        // @optional -(void)onResp:(id)resp;
        [Export("onResp:")]
    ...
    interface WXApi
    {
        ...
        // +(BOOL)sendAuthReq:(id)req viewController:(id)viewController delegate:(id<WXApiDelegate>)delegate;
        [Static]
        [Export("sendAuthReq:viewController:delegate:")]
        bool SendAuthReq(NSObject req, NSObject viewController, WXApiDelegate @delegate);

        // +(BOOL)sendResp:(id)resp;
        [Static]
        [Export("sendResp:")]
        bool SendResp(NSObject resp);
    }
